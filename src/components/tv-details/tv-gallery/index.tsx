...
import {getTvGallery} from "@/lib/services/tv/get-tv-gallery";

export async function TvGallery({id}: {id: Tv["id"]}) {
  const {backdrops, posters} = (await getTvGallery(id)) as TvGallery;
