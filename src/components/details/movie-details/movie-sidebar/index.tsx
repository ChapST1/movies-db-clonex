...
export function MovieDetailSidebar({info}: {info: MovieDetail}) {
  ...
  return (
    <nav className="top-16 order-[-1] my-5 flex flex-col overflow-y-auto md:sticky md:order-none md:h-[calc(100dvh-64px)] md:border-l md:border-border md:px-5 md:py-3 ">
